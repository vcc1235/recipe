package com.vcc.recipe.recipe.vo;
...
public class VisitorVo implements java.io.Serializable {
	...
	public VisitorVo(Visitor visitor){
		
		this.visitorId = visitor.getVisitorId() ;
		this.visitorName = visitor.getVisitorName() ;
		this.visitorAvator = visitor.getVisitorName() ;
		this.visitorSex = visitor.getVisitorSex() ;
		this.visitorDevice = visitor.getVisitorDevice() ;
